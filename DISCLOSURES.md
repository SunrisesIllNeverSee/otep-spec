...
**Status:** Bootstrap — interim disclosure record per `GOVERNANCE.md` SRP-GOV-013/014.
**Last updated:** 2026-08-30

---

## Interim Lead Maintainer

**Name:** Deric (DREP1)
**Email:** burnmydays@proton.me
**Role:** Interim Lead Maintainer (project founder), per `GOVERNANCE.md` SRP-GOV-003/005.
**Appointed:** 2026-08-28 (repository establishment date).
**Authority:** Release authority for v0.x draft stabilization. Terminates upon TSC establishment (SRP-GOV-009).
...
Per SRP-GOV-014, this file MUST be updated within 30 days of any material change in commercial affiliation or maintainer appointment.
